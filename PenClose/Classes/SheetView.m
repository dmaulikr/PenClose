...
{
#ifdef LOG_TIME
    NSDate *fromDate = [[NSDate date] retain];
#endif
...
#ifdef LOG_TIME
    NSTimeInterval elapsed = [[NSDate date] timeIntervalSinceDate:fromDate];
    ...
    static char elapsedStr[100];
    sprintf(elapsedStr, "%f", elapsed);
	CGContextShowTextAtPoint(context, 0.0, 0.0, elapsedStr, strlen(elapsedStr));*/
#endif
}
